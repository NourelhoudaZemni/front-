                ...
                <div className="single-shop-products">
                  <div className="shop-products-image">
                    <Link to={`/products-details/${product._id}`}>
                      ...
                      <img src={product.image} style={{width:"361px", height:"365px" }}alt="image" />
                    </Link>
                    <div className="tag">{product.discount!=0? "Discount "+product.discount*100+"%" : "New"}</div>
                    <ul className="shop-action">
                      ...
                      <li>
                          <span className="addtocart-icon-wrap" onClick={()=>{addToWishList(product._id,idUser)}}>
