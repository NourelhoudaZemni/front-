...
function MyAuctionsArea({  history, editAuction ,page, pages, keyword,showQuickView}) {
...
_id:""
  ...
  const [auction, setAuction] = useState([] );
   ...
   useEffect(async() => {
     console.log("eyy dkhalt gbal")
   await  axios
      .get("/auction/fetchMyAuctions/"+id)
      .then((res) => {
...
&nbsp;
                      <Link to={`/update-auction/${ auction._id}`}>
...
export default withRouter(MyAuctionsArea);
